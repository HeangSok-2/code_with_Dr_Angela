...
_recipes_pil_prescript(['SunImagePlugin', 'PalmImagePlugin', 'BlpImagePlugin', 'WebPImagePlugin', 'DdsImagePlugin', 'XVThumbImagePlugin', 'MicImagePlugin', 'WmfImagePlugin', 'DcxImagePlugin', 'Jpeg2KImagePlugin', 'McIdasImagePlugin', 'PngImagePlugin', 'XbmImagePlugin', 'SpiderImagePlugin', 'MpegImagePlugin', 'GribStubImagePlugin', 'MpoImagePlugin', 'BmpImagePlugin', 'BufrStubImagePlugin', 'MspImagePlugin', 'FitsStubImagePlugin', 'ImtImagePlugin', 'TgaImagePlugin', 'PsdImagePlugin', 'FpxImagePlugin', 'GbrImagePlugin', 'SgiImagePlugin', 'FliImagePlugin', 'IptcImagePlugin', 'EpsImagePlugin', 'PcxImagePlugin', 'IcoImagePlugin', 'JpegImagePlugin', 'PdfImagePlugin', 'XpmImagePlugin', 'IcnsImagePlugin', 'GifImagePlugin', 'CurImagePlugin', 'TiffImagePlugin', 'PixarImagePlugin', 'PcdImagePlugin', 'ImImagePlugin', 'FtexImagePlugin', 'PpmImagePlugin', 'Hdf5StubImagePlugin'])
